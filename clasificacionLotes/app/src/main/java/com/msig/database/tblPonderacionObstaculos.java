 ...
 */
public class tblPonderacionObstaculos {
    Context context;
    RelativeLayout container;
    private String URL = "";
    private String function = "fn_obtener_ponderacion_obstaculo";

    public tblPonderacionObstaculos(Context context, RelativeLayout container, String server, String system) {
    ...
    private void insertartabla(String nombre, String ponderacion){
        ...
        try {
            ...
            bd.execSQL("insert into ponderacion_obstaculos (nombre,ponderacion) values ('"+nombre+"','"+ponderacion+"')");
            bd.close();
        }catch (Exception e){
            System.out.println("ERROR EN CONSULTA AL CARGAR PONDERACION OBSTACULOS"+e);
        }
    }
}
