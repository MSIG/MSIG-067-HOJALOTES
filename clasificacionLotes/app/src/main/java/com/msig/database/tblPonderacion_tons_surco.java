 ...
 */
public class tblPonderacion_tons_surco {
    Context context;
    RelativeLayout container;
    private String URL = "";
    private String function = "fn_obtener_ponderacion_tons_surco";

    public tblPonderacion_tons_surco(Context context, RelativeLayout container, String server, String system) {
    ...
    private void insertartabla(String nombre, String ponderacion){
        ...
        try {
            ...
            bd.execSQL("insert into ponderacion_tons_surco (tons_surco,ponderacion) values ('"+nombre+"','"+ponderacion+"')");
            bd.close();
        }catch (Exception e){
            System.out.println("ERROR EN CONSULTA AL CARGAR PONDERACION TONS/SURCO"+e);
        }
    }
}
