 ...
 */
public class tblPonderacionTipoSuelo {
    Context context;
    RelativeLayout container;
    private String URL = "";
    private String function = "fn_obtener_ponderacion_tipo_suelo";

    public tblPonderacionTipoSuelo(Context context, RelativeLayout container, String server, String system) {
    ...
    private void insertartabla(String nombre, String ponderacion){
        ...
        try {
            ...
            bd.execSQL("insert into ponderacion_tiposuelo (nombre,ponderacion) values ('"+nombre+"','"+ponderacion+"')");
            bd.close();
        }catch (Exception e){
            System.out.println("ERROR EN CONSULTA AL CARGAR PONDERACION TIPO SUELO"+e);
        }
    }
}
