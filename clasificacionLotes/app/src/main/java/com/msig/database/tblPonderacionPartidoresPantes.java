 ...
 */
public class tblPonderacionPartidoresPantes {
    Context context;
    RelativeLayout container;
    private String URL = "";
    private String function = "fn_obtener_ponderacion_partidor_pante";

    public tblPonderacionPartidoresPantes(Context context, RelativeLayout container, String server, String system) {
    ...
    private void insertartabla(String nombre, String ponderacion){
        ...
        try {
            ...
            bd.execSQL("insert into ponderacion_partidorespantes (nombre,ponderacion) values ('"+nombre+"','"+ponderacion+"')");
            bd.close();
        }catch (Exception e){
            System.out.println("ERROR EN CONSULTA AL CARGAR PARTIDORES PANTES"+e);
        }
    }
}
